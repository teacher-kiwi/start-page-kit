          ...
          <Card className="p-6">
            <div className="text-center space-y-4">
              ...
              <div className="flex justify-center">
                {qrCodeUrl ? <div className="p-4 bg-white rounded-xl shadow-sm border cursor-pointer hover:shadow-md transition-shadow" onClick={handleQRCodeClick} title="클릭하여 설문 페이지로 이동">
                    <img src={qrCodeUrl} alt="설문지 QR코드" className="w-48 h-48 mx-auto" />
                  </div> : <div className="w-48 h-48 flex items-center justify-center border border-border rounded-xl">
              ...
              {/* 다운로드 버튼 */}
              <Button onClick={handleDownload} variant="outline" disabled={!qrCodeUrl} className="flex items-center gap-2">
